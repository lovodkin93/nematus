...
class ConfigSpecification:
    ...
    def _define_param_specs(self):
        ...
        group.append(ParameterSpecification(
            name='source_parent_scaled_head', default=False,
            visible_arg_names=['--source_parent_scaled_head'],
            action='store_true',
        ...
        group.append(ParameterSpecification(
            name='source_parent_scaled_masks_layers', default='all_layers',
        ...
        group.append(ParameterSpecification(
            name='source_train_parent_scaled_masks', default=None,
            visible_arg_names=['--source_train_parent_scaled_masks'],
            type=str, metavar='PATH',
            help='parent scaled mask for the source (train set)'))

        group.append(ParameterSpecification(
            name='source_valid_parent_scaled_masks', default=None,
        ...
        group.append(ParameterSpecification(
            name='source_valid_bleu_parent_scaled_masks', default=None,
            visible_arg_names=['--source_valid_bleu_parent_scaled_masks'],
...
# if 'source_valid_bleu_parent_scaled_masks' is not declared, then set it same
# as 'source_valid_parent_scaled_masks'
def _derive_source_valid_bleu_parent_scaled_masks(config, meta_config):
